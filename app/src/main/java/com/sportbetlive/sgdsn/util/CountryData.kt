...
object CountryData {
    ...
    val countries: List<Country> = listOf(
        ...
        Country("UZ", "Oʻzbekiston", "+998", "uz", "🇺🇿", PhoneValidationRule(9, startsWith = listOf("33", "55", "9"))),
        Country("TJ", "Тоҷикистон", "+992", "tg", "🇹🇯", PhoneValidationRule(9, startsWith = listOf("55", "9"))),
        ...
        Country("IT", "Italia", "+39", "it", "🇮🇹", PhoneValidationRule(10, startsWith = listOf("3"))),
        ...
        Country("KR", "대한민국", "+82", "ko", "🇰🇷", PhoneValidationRule(10, minLength = 9, maxLength = 10, startsWith = listOf("10", "11", "16", "17", "18", "19"))),
        ...
        Country("RS", "Србија", "+381", "sr", "🇷🇸", PhoneValidationRule(9, minLength = 8, maxLength = 9, startsWith = listOf("6"))),
        ...
        Country("ID", "Indonesia", "+62", "id", "🇮🇩", PhoneValidationRule(11, minLength = 10, maxLength = 12, startsWith = listOf("8"))),
        ...
        Country("LB", "لبنان", "+961", "ar", "🇱🇧", PhoneValidationRule(8, minLength = 7, maxLength = 8, startsWith = listOf("3", "7", "8"))),
        ...
        Country("ET", "ኢትዮⵯያ", "+251", "am", "🇪🇹", PhoneValidationRule(9, startsWith = listOf("9"))),
        Country("GA", "Gabon", "+241", "fr", "🇬🇦", PhoneValidationRule(8, startsWith = listOf("0"))),
        ...
        Country("KE", "Kenya", "+254", "sw", "🇰🇪", PhoneValidationRule(9, startsWith = listOf("1", "7"))),
        ...
        Country("AR", "Argentina", "+54", "es", "🇦🇷", PhoneValidationRule(11, minLength = 10, maxLength = 11)),
        ...
        Country("NZ", "New Zealand", "+64", "en", "🇳🇿", PhoneValidationRule(9, minLength = 8, maxLength = 10, startsWith = listOf("2"))),
